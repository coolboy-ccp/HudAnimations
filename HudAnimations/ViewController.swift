...
//        let hud = CCPHud(frame: CGRect(x: 100, y: 100, width: 100, height: 100), type:.ballClipRotate, color: UIColor.red)
//        view.addSubview(hud)
//        hud.startAnimating()
        
        let hud = CCPHud(frame: CGRect(x: 100, y: 100, width: 100, height: 100), type:.squareSpin, color: UIColor.red)
        view.addSubview(hud)
        hud.startAnimating()
